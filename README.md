# AI-for-SEO
list of tools, prompts, platforms, and resources that use AI for SEO — from content generation and keyword clustering to automated audits, SERP tracking, and technical optimization.
